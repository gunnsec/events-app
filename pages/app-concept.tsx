...
// TODO: this is on a temp route because its super unfinished and the implementation details should be more thought out,
// move it to `/app` or something else fitting when finished
export default function Home() {
    return (
        <div>
            <Head>
                <title>Events App | SEC</title>
                <meta name="description" content="The app for keeping track of SEC events." />
            </Head>

            <main className="py-24">
                <section className="container flex flex-col lg:flex-row gap-8 justify-between mb-8">
                    <div>
                        <h1 className="font-[Limelight] font-medium text-9xl underline decoration-4 underline-offset-4 -mb-11">
                            Home-
                        </h1>
                        <h1 className="font-[Limelight] font-medium text-9xl underline decoration-4 underline-offset-4 pl-16 mb-6">
                            coming!
                        </h1>
